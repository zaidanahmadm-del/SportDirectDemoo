/* Null-safe interface that hides vendor UI we don't need */
function CInterface(){
    this._oButExit = this._oButPause = this._oAudioToggle = null;
    this._oScoreText = this._oShotsText = null;
    this._oScoreContainer = this._oShotsContainer = null;
    ...
    this.refreshButtonPos = function(){
        ...
        if (this._oScoreText)    setPos(this._oScoreText,    this.getStartPosScore());
        if (this._oShotsText)    setPos(this._oShotsText,    this.getStartPosShots());
        if (this._oButExit)      setPos(this._oButExit,      this.getStartPosExit());
        if (this._oAudioToggle)  setPos(this._oAudioToggle,  this.getStartPosAudio());
        if (this._oButPause)     setPos(this._oButPause,     this.getStartPosPause());
    };
